...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="leading-loose">
            <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" method="POST" action="/login/join">
              @csrf
              <p class="text-gray-800 font-medium">Customer information</p>
              <div class="">
                <label class="block text-sm text-gray-00" for="cus_name">ID</label>
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="id" name="id" type="text" required="" placeholder="Your ID" aria-label="ID">
              </div>
              <div class="">
                <label class="block text-sm text-gray-00" for="cus_name">Name</label>
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="user_name" name="user_name" type="text" required="" placeholder="Your Name" aria-label="Name">
              </div>
              <div class="mt-2">
