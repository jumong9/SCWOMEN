...
@section('content')
    ...
    <form name="searchForm" id="searchForm" action="{{route('mgmt.application.updateDo') }}" onsubmit="return searchFormSubmit();" method="post" >
    @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#cancelButton").click(function(){
                location.href='{{ route('mgmt.application.read')}}' + params + "&id={{$member[0]->id}}";
            });
