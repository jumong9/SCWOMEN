...
@section('content')
    ...
    <form name="searchForm" id="searchForm" action="{{route('mgmt.client.create') }}" onsubmit="return searchFormSubmit();" method="post" >
    @csrf
    <!-- DataTales Example -->
                    ...
                    <tbody class="thead-light " style="border-bottom: 1px solid #dee2e6;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-6">
                                        <input id="office_tel" type="email" class="form-control @error('office_tel') is-invalid @enderror" name="office_tel" value="" >
                                    </div>
                                </div>
                            </td>
                            <th>행정실팩스</th>
