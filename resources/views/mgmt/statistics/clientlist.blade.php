...
@section('content')
    ...
    <form name="searchForm" id="searchForm"  action="{{route('mgmt.statistics.clientlist') }}" method="post" >
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $list->client_gubun_value}}</td>
                            <td>{{ $list->name }}</td>
                            <td>{{ number_format($list->class_number) }}</td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#exportExcelButton").click(function(e){
                $("#searchForm").attr("action", "{{ route('mgmt.statistics.exportClientExcel') }}");
                $("#searchForm").submit();
                $("#searchForm").attr("action", "{{route('mgmt.statistics.clientlist') }}");
            });
