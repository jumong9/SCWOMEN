...
@section('content')
    ...
    <form name="searchForm" id="searchForm"  action="{{route('mgmt.statistics.lectorsumlist') }}" method="post" >
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#exportExcelButton").click(function(e){
                $("#searchForm").attr("action", "{{ route('mgmt.statistics.exportLectorSumExcel') }}");
                $("#searchForm").submit();
                $("#searchForm").attr("action", "{{route('mgmt.statistics.lectorsumlist') }}");
            });
